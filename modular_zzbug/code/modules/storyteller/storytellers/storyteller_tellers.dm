/datum/storyteller/lowpop_guide
	name = "Lowpop Andy"
	desc = "Andy is the default Storyteller, and the comparison point for every other Storyteller. Best for an average, varied experience. Lowpop accounts for the fact that targeted and destructive events are more dangerous with few crew."
...
/datum/storyteller/trusty
	name = "Trusty"
	desc = "Trusty removes all player-controlled antags. Good for co-operative-focused rounds!"
	antag_divisor = 0
	population_min = 8
